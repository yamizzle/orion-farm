...
| Critical | Partial 9/1 4:46pm live | Sword: Space+hotbar kills; on-screen button and facing still miss | Mine / HUD | UPDATE 9/1 ~4:46pm live BUILD 20260831q: sword pad still drawn on MINE 6 but tap showed no swing arc/anim; bat KO'd Orion before a live hit could be verified. STILL pad-only (not in 10-tray). Prior 1:07pm: pad drew+swung on MINE 1/2 but foes ignored it. |

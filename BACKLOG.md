...
| Critical | Open | Mine entrance not discoverable | Farm W / Forest | 8/22 3pm new. Junie (cave mushroom) and Reed (lantern in the mine) quest you there, but a 15-min sweep of the farm west edge (both halves) and N/W forest found no cave/hole. Blocks the entire mine feature set (sword, shards, slugs, Mine 2). High-contrast cave mouth on the farm west dirt path + signpost, or a map/arrow hint. |
| High | Worse | Rocks don't react; no stone | Farm / mine | 8/22 3pm: escalated. Adjacent+Space and tap did nothing — no vanish, no chip, stone stayed 0. Was "vanish with no stone"; now they ignore input entirely. |

...
Local 9/2 (BUILD 20260831s): sword pad hit is omnidirectional (8-neighbor tiles + reach 52 + Chebyshev≤1 any facing); bat/flying contact uses wider radius so adjacent-tile overlap drains hearts (i-frames kept); placeToolInTrayFirst forces sword into tray even when bag is full. Needs live. Household save intact. Never START OVER.
...
Last live pass: **2026-09-01 ~10:22pm PT** BUILD 20260831r (cache-bust `?v=pt2212`). Continued box Chrome save Day 1258 SPRING AFTERNOON→1259 AFTERNOON (~12 min). Farm spawn at MINE sign → MINE 1→2. Sword-pad kill PASS (bat coin + slime ore); contact damage FIXED on MINE 2 slimes (5→2 hearts); MINE 1 bats still zero contact. Sword still pad-only. Never START OVER. Screenshots `/workspace/playtest-2212/`.

Highest-leverage theme: Local 9/2 BUILD 20260831s ships omnidirectional sword hits + bat contact widen (Needs live). Prior 9/1 ~10:22pm 31r: pad kill PASS with loot; facing-limited left miss; slime contact FIXED; bat contact zero; sword pad-only. Clock STILL races. START OVER still under Jobs.
...
| Medium | Partial 9/1 1:15am live | Ocean and boats south of the house | Overworld S / ocean | UPDATE 9/1 ~1:15am live BUILD 20260831o: east foam/deep walk **FIXED**; beach grass→sand→foam Imagine bands PASS; boats/ride still decor-only / untested this pass. UPDATE 8/31 5:50am live BUILD 20260831a: path enter/exit **PASS**; dock boats **PASS** visible (5+ rowboats + sailboat) but decor-only (no ride). **NEW BUG:** walk on open/deep ocean water past surf (`07-walking-on-open-water.webp`, `11-deep-water-walk-bug.webp`). **NEW cosmetic:** night tint washes whole cove incl. player then snaps bright (`08-water-walk-night-lighting-mismatch.webp`). Prior 2:19am: OCEAN sign walk-in PASS; boats not on first screen. Local 8/30 BUILD 20260830l. NEW 8/30 Darren.
...
- Needs live: left/right pad kills, MINE 1 bat contact, sword appearing in tray on a sword-owned save.

...
Highest-leverage theme: LIVE 9/3 ~7:26am BUILD 20260903a: the 03a combat fixes cover BATS only — slimes still multi-drain with no i-frames and shrug off the sword pad. Fix slime damage + pad-vs-slime next; keep enemies out of the sword-pad/hotbar gutter; soften the `YOU DIED...` copy. Sword STILL missing from tray; clock STILL races.

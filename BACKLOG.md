...
| --- | --- | --- | --- |
| Medium | Local Partial 9/25 05jw | Squirrel spell → tree hole → treetops | **Local Partial (spell + hole toast):** BUILD 20260905jv squirrel transform; **05jw** darkForest far tree HOLE toast (TOO BIG / A SQUIRREL HOLE!; jobs tip). Hollow climb room / treetops still **Open**. Gate: Cloud City squirrel spell. Teach Orion via tiny shippable slices (spell only → hole toast → climb room → treetops). Never START OVER. Hero is Orion / YOU (no Esther). |

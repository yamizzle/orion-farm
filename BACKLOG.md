...
Highest-leverage theme: Combat slime/death/bag-sword FIXED on live 03b. Still open: force sword into the visible 10-tray (BAG-only this pass), day-clock races (human), START OVER placement (human).

...
Local 9/4 BUILD 20260904b tray-sword harden — no tool mirroring into bag; recover swordOwned from pocket ghosts; openBag re-pins; version.json matched. Walk energy / day clock / START OVER / Orion art / grass / evening color untouched. Do not mark Critical sword Done until live. Never START OVER.
...
Last live pass: **2026-09-04 ~1:16–1:34am PT** BUILD 20260904a (desktop; URL still `?v=20260903b`). First live of 04a. Continued box Chrome save Day 2150 MINE 1 (2/5♥, 0G) → 2151 MINE 2 (1–4/5♥, 0G). **STILL FAIL:** sword not in 10-tray (slot 0 seeds; BAG grid slot 1 has sword). **PASS/STILL:** slime i-frames + 1-tap pad kill (ore loot); bat i-frames (−1 then hold) + 1-tap pad kill. **STILL:** clock races; START OVER under Jobs. Never START OVER. Screenshots `/workspace/playtest-0116/`.

Highest-leverage theme: Combat slime/bat/death still good on live 04a. Tray sword STILL FAIL on first live of 20260904a (BAG-only again) — forceSwordIntoTray still not pinning slot 0. Also bump `assets/version.json` to match BUILD (live still serves `20260903b`). Still open: tray sword, day-clock races (human), START OVER placement (human).

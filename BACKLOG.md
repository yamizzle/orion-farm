...
Local 9/2 (BUILD 20260831u): PEAK winding dirt is walkable (old mask hugged the left cliff); summit rocks stay blocked. Household save intact. Never START OVER.
...
Last live pass: **2026-09-02 ~10:26–11:22am PT** BUILD 20260831t (desktop; `?v=pt1017b`). Continued box Chrome save Day 1599 SPRING MORNING→1605 AFTERNOON (~56 min wall; play ~mine). HOUSE 2/5♥ 17G → faint → house full hearts → MINE 1 → FARM 5/5♥ 16G. **FIXED:** pad-over-OUT (31t) — sword pad at OUT swung, no exit (`06-pad-over-out.webp`); OUT one-tap still PASS (`07-out-pass.webp`). **WORSE:** bat multi-drain to KO again (vs 8am survived −1♥); −1G on faint (`03`–`04`). **STILL FAIL:** pad kill — 2 taps knockback only, no loot (31t 4-dmg claim miss). Sword STILL pad-only. Clock STILL races (1599→1605). START OVER STILL in Jobs. Never START OVER. Screenshots `/workspace/playtest-1017/`.

Highest-leverage theme: LIVE 9/2 ~10:26am BUILD 20260831t: pad-over-OUT FIXED; pad kill STILL knockback-only (31t dmg miss); bat KO WORSE again; sword STILL pad-only; clock STILL races; START OVER still under Jobs.

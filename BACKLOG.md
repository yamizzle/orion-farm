...
Last live pass: **2026-09-03 ~7:26–7:45am PT** BUILD 20260903a (desktop; `?v=pt0725`). Continued box Chrome save Day 2037 NIGHT → 2039 MORNING. Bats STILL good (−1♥ + i-frames hold; pad kills in ~2 taps; ore loot now confirmed). **NEW/WORSE:** slimes have NO i-frames (5→4→2♥ in ~4s, instant death from 2♥) and the sword pad does not kill them (2 taps, no loot). **NEW:** slime spawns behind the sword pad/hotbar (unclickable); death box says `YOU DIED...` instead of `THE MOUNTAIN SENT YOU HOME`. **STILL:** no tray sword; clock races; START OVER under Jobs. MINE 2+ / PEAK chain UNTESTED. Never START OVER. Screenshots `/workspace/playtest-0725/`.

Highest-leverage theme: Local 9/3 BUILD 20260903b ships slime combat + death-copy + gutter + Space pedestal (needs live). Still open after that: tray sword verification on household save, day-clock races (human), START OVER placement (human).

...
| **Legible stack counts + HUD text** — shared `denseText()` 1:1 bright cream/white + 1px dark outline (pre-05hx count recipe); no NN downscale crush; HUD/BAG/floats same family; day panel ~21 | 20260905ig (was 05if/hx) | KEEP |
...
*Last sweep: 2026-09-07 — 05ig legible white+outline counts/HUD; 05id walk-through entrance labels kept; prior 05a–05ic keep-list still applies.*

...
| **Press Start 2P locked fonts** — tray/bag counts **8px** cream `#FFF8E8` + thin dark outline + tiny shadow (`drawSlotCount`; same size as HUD/labels; no 05hx 0.85/4×; not 16px); world labels 8px white + thin cardinal outline (OUT no gold); HUD DAY/clock/BAG/place 8px white+outline, money gold, no energy "E"; `clockHudLine` `SPR · AM|PM|EVE|NIGHT`; FontFace load gated with boot; dialogue may stay legacy FONT | 20260905in | KEEP |
...
*Last sweep: 2026-09-07 — 05in tray/bag counts 8px Press Start cream (was 05im 16px); HUD/labels/clock untouched; 05id walk-through entrance labels kept; prior 05a–05ic keep-list still applies.*

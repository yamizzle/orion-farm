...
- Tap a tree or a rock from the next tile. Hands take **five** hits. Craft an **axe** or **pick** at the workbench, select it on the belt, and it drops to **two** hits (mine rocks are faster with a pick). The right tool also shows in Orion's hand and drops extra wood or stone. A chopped stump grows back after about a day; a smashed rock comes back too — unless you built or dug on that tile.

...
- Jobs: bring Junie a cave mushroom, leave wood at Nim's note after you read the mine letter, then take a moon shard inside the house. After it comes home the shard sits on the table as the Home Light, the lamp feels warmer, and the job book says the town statue is still dark.

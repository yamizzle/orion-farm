...
- Jobs: bring Junie a cave mushroom, leave wood at Nim's note after you read the mine letter, then take a moon shard inside the house. After it comes home the shard sits on the table as the Home Light and the lamp feels warmer. The job book then says to plant flowers with Lila. After three flowers on the town green and her thanks, it says the town statue is still dark.
...
- Town folk: **Pip** keeps the shop, **Lila** waters the green, **Reed** watches the red car. Tap them to talk. Lila wants three flowers on the town green (the meadow around the fountain and statue). The car loops the cobble and waits if you stand in the road.
